<div class="diagnole-borders relative px-3 py-2 md:px-6 md:py-4">
    <form wire:submit="save">
        @if ($firstView)
                ...
                <div class="mt-6 space-y-6">
                    <div class="relative flex gap-x-3">
                        ...
                        <div class="text-sm leading-6">
                            <label for="landingPage" class="font-medium text-black">Piezemēšanās (landing) lapa</label>
                        </div>
                    </div>
                    <div class="relative flex gap-x-3">
                        <div class="flex h-6 items-center">
                    ...
                    <div class="sm:col-span-4">
                        <label for="q1SomethingElse" class="block text-sm font-medium leading-6 text-black">
                            Kaut kas cits?
                        </label>
                        <div class="mt-2">
                            <div
            ...
            <div>
                <x-primary-button type="submit" class="mt-5 uppercase md:mt-10">Tālāk</x-primary-button>
            </div>
        @elseif ($secondView)
        @endif
    </form>
